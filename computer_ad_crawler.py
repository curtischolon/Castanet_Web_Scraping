...
def find_number_of_ads():
    ...
    home_url = "https://classifieds.castanet.net/cat/electronics/"
    ...
    header = number_of_soup_ads.find(name='a', href='computers/')
    ...
    number_of_ads = number_of_ads.replace("/ ", "").strip()
...
base_url = "https://classifieds.castanet.net/cat/electronics/computers/?p="
...
columns = ['Ad_Name', 'ID', 'AD Date', 'Price', 'Location', 'URL']
...
listing_path = os.path.join('C:\\', 'users', 'ccholon', 'my documents', 'castanet images', 'computer_listings.xlsx')
